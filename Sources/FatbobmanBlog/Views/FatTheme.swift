...
//                                .href(context.sections[section].path)
    ...
    static func connectMe() -> Node {
        ...
        .raw(
            ...
            <style>
              .connectMe {
                background-color: #e7f1f0; /* 标准模式下的背景色 */
                color: #454545; /* 标准模式下的字体颜色 */
                border: 1px solid #19533e; /* 标准模式下的边框样式和颜色 */
                border-radius: 5px;
                padding: 10px;
              }
              .connectMe .donate {
                background-color: #19533e; /* 捐赠部分的背景色 */
                color: #ffffff; /* 捐赠部分的字体颜色 */
                padding: 5px;
                border-radius: 3px;
              }
              @media (prefers-color-scheme: dark) {
                .connectMe {
                  background-color: #1a1a1a; /* 暗黑模式下的背景色 */
                  color: #dddddd; /* 暗黑模式下的字体颜色 */
                  border: 1px solid #999999; /* 暗黑模式下的边框样式和颜色 */
                }
                .connectMe .donate {
                  background-color: #999999; /* 暗黑模式下捐赠部分的背景色 */
                }
              }
            </style>
            <div class="connectMe">
