...
//    }
    ...
    static func substackHeader() -> Node {
        .raw(
            """
            ...
            <script>
              window.CustomSubstackWidget = {
                substackUrl: "fatbobman.substack.com",
                placeholder: "fatbobman's Swift Weekly",
