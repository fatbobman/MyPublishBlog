...
2020 年夏天，在为 [健康笔记](https://fatbobman.com/healthnotes/) 添加侧向滑动菜单的过程中，我发现在开发中经常会碰到需要在一个视图的上方动态添加另一视图的场景，例如（提示信息、广告、浮动按钮、新手指南等等）。因此，我写了一个组件希望可以帮助开发者在 SwiftUI 中快速完成上述需求。但受限于当时的技术能力，很多的想法都没有能够很好地实现。
